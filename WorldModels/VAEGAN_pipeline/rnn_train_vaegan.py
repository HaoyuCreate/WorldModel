...
model_save_path = "results/{}/tf_rnn_vaegan".format(args.env_name)
if not os.path.exists(model_save_path):
  os.makedirs(model_save_path)
with open(model_save_path + '/args.json', 'w') as f:
    json.dump(args.__dict__, f, indent=2)
raw_data = np.load(os.path.join(DATA_DIR, "series_vaegan.npz"))
...
with open(os.path.join(initial_z_save_path, "initial_z_vaegan.json"), 'wt') as outfile:
